export function getInviteEmail (link, facilityName) {
  return `<!DOCTYPE html>
                              ...
                              <tr>
                                <td bgcolor="#fbfaff" align="center" style="padding:12px;Margin:0">
                                  <h3
                                    ...
                                    Welcome to ${facilityName} Facility!
                                  </h3>
                                  <p style="font-weight:400;font-size:14px;color:#191919;font-family:Inter, Arial;">
                                    You’ve been invited to collaborate with the ${facilityName} Facility using WePlay.ai software. Please click on the confirmation below to get started.</p>
                                </td>
                              </tr>
                            </table>
                          </td>

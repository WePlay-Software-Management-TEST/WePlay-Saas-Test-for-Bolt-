export function getNotifyPlayerEmail (tournamentName, teamName, playerEmail, redirectUrl = 'localhost:4200') {
  return `
         <!DOCTYPE html>
                                  ...
                                  <table
                                    ...
                                    <tr>
                                      <td class="h-auto" height="63" bgcolor="#fbfaff" align="center"
                                        ...
                                        <p
                                          style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;color:#2D3142;font-size:26px;font-weight: bold;">
                                          You have been added to the “${tournamentName}” tournament for the ,”${teamName}”.&#128075;
                                        </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td bgcolor="#fbfaff" align="center" style="padding:12px;Margin:0">
                                        ...
                                        <p style="font-weight:400;font-size:14px;color:#191919;font-family:Inter, Arial;">
                                         Congratulations! 🎉 You’re now an official player in the ${tournamentName} tournament with ${teamName}.
  
  Get ready for a seamless experience! Click the link below to stay updated with all the tournament details, including locations, schedules, teams, scores, and more. .</p>
     ...
     <tr>
                                  <td class="h-auto" valign="middle" height="59" align="center"
                                    style="padding:0;Margin:0">
                                    <a href="${redirectUrl}signup?email=${encodeURIComponent(playerEmail)}&bt=withEmail" class="linkAnchor"

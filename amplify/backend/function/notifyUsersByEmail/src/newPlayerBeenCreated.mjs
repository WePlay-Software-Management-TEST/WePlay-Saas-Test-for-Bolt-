export function getNewPlayerBeenCreatedEmail (userName, facilityName) {
  return `
  <!DOCTYPE html>
                              ...
                              <table
                                ...
                                <tr>
                                  <td class="h-auto" height="63" bgcolor="#fbfaff" align="center"
                                    ...
                                    <p
                                      style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:63px;color:#2D3142;font-size:42px">
                                      Hey ${userName} &#128075;
                                    </p>
                                  </td>
                                </tr>
                                <tr>
                                  <td bgcolor="#fbfaff" align="center" style="padding:12px;Margin:0">
                                    <h3
                                      style="Margin:0;line-height:21px;mso-line-height-rule:exactly;font-family:Inter, Imprima, Arial, sans-serif;font-size:14px;font-style:normal;font-weight:700;color:#191919;margin-bottom:16px;line-height: 120%;letter-spacing: 0.005em align-text: center">
                                      We’re glad to inform you that you’ve added to the ${facilityName} Facility as a player.
                                    </h3>
                                    <p style="font-weight:400;font-size:14px;color:#191919;font-family:Inter, Arial;">
                                      We're thrilled to welcome you to our facility and embark on this exciting journey together, powered by our advanced facility management software solution, WePlay.</p>
                                  <p style="Margin:0;line-height:21px;mso-line-height-rule:exactly;font-family:Inter, Imprima, Arial, sans-serif;font-size:14px;font-style:normal;font-weight:400;color:#191919;margin-bottom:16px;line-height: 120%;letter-spacing: 0.005em align-text: center"">
  You can now access your teams if you are part of one, upcoming tournaments, and leagues. Your experience matters to us, and that's why we're committed to providing you with all the essentials to gear up for your games.</p>
                                    </td>
                                </tr>
                              </table>
                            </td>
